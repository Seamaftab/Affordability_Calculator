...
url = 'https://darlingtonbs.asanto.com/engine/mortgage/darlington_hosted_resi/'
...
def get_mortgage_data(data):
    ...
    mortgage_data["search_id"] = "553d0275-4f6b-465d-8386-30619cd799d1"
...
def get_applicants(data):
    ...
    for applicant in applicant_details:
        ...
        Darlington = {
            ...
            "annual_net_profit_current": applicant["Employment Details"].get("Last Year's Net Profits", 0),
            "annual_net_profit_previous": applicant["Employment Details"].get("Previous Year's Net Profits", 0),
            "annual_directors_salary_current": applicant["Employment Details"].get("Last Year's Salary", 0),
            "annual_directors_salary_previous": applicant["Employment Details"].get("Previous Year's Salary", 0),
            "annual_gross_dividend_current": applicant["Employment Details"].get("Last Year's Dividends", 0),
            "annual_gross_dividend_previous": applicant["Employment Details"].get("Previous Year's Dividends", 0),
        ...
        applicant_data.append(Darlington)
